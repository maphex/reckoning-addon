...
function commsUtils:Decode(encoded)
    ...
    -- Use pcall to catch any decompression/decoding errors silently
    ...
    if success then
        ...
        -- Silently fail - the message may have been corrupted or from a different version
        return nil
    end
end
...
function commsUtils:Encode(data)
    ...
    -- Use pcall to catch any encoding errors
    local success, result = pcall(function()
